...
from models.disnet_with_dinov2_sd import DisNet as Model
...
def distill(train_loader, model, optimizer, epoch, awl_model):
    ...
    for i, batch_data in enumerate(train_loader):
        ...
        elif hasattr(args, 'loss_type') and args.loss_type == 'smoothl1':
            loss_lseg = torch.nn.SmoothL1Loss()(output_3d, feat_3d)
