...
from run.distill_uncertainty_with_EMA_v2_dinov2 import get_model
        ...
        for rep_i in range(args.test_repeats):
            ...
            for i, (coords, feat, label, feat_3d, mask, inds_reverse) in enumerate(tqdm(val_data_loader)):
                ...
                if feature_type == 'distill':
                    predictions, uncertainty_pred_lseg, output_3d_dinov2, uncertainty_pred_dinov2 = model(sinput)
