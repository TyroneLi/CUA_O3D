...
from dataset.feature_loader_with_dinov2 import FusedFeatureLoader, collation_fn
from dataset.point_loader_with_dinov2 import Point3DLoader, collation_fn_eval_all
from models.disnet_with_dinov2 import DisNet as Model
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    awl_model = AutomaticWeightedLoss(num=2)
    ...
    #                               {awl_model.parameters(), 'weight_decay':0}
    #                               ], lr=args.base_lr)
...
def distill(train_loader, model, optimizer, epoch, awl_model):
    ...
    for i, batch_data in enumerate(train_loader):
        ...
        (coords, feat, label_3d, feat_3d, dinov2_feat_3d, mask) = batch_data
        ...
        output_3d, output_3d_dinov2 = model(sinput)
        ...
        # loss = loss_lseg + loss_dinov2
        loss = awl_model([loss_lseg, loss_dinov2])
        ...
        if (i + 1) % args.print_freq == 0 and main_process():
            logger.info('Epoch: [{}/{}][{}/{}] '
                        ...
                        'AML_Param_2 {aml_model_params_2:.4f} '.format(epoch + 1, args.epochs, i + 1, len(train_loader),
