...
from models.disnet_with_dinov2_adaptiveFN import DisNet as Model
...
def distill(train_loader, model, optimizer, epoch):
    ...
    for i, batch_data in enumerate(train_loader):
        ...
        output_3d, output_3d_unc, output_3d_dinov2, output_3d_dinov2_unc = model(sinput)
        output_3d = output_3d[mask]
        output_3d_dinov2 = output_3d_dinov2[mask]
        output_3d_unc = output_3d_unc[mask]
        output_3d_dinov2_unc = output_3d_dinov2_unc[mask]
        ...
        loss_lseg_sum = (output_3d_unc ** 2) * loss_lseg + torch.log(1.0 + output_3d_unc ** 2)
        loss_dinov2_sum = (output_3d_dinov2_unc ** 2) * loss_dinov2 + torch.log(1.0 + output_3d_dinov2_unc ** 2)
        
        loss_lseg = loss_lseg_sum.mean()
        loss_dinov2 = loss_dinov2_sum.mean()
        ...
        if (i + 1) % args.print_freq == 0 and main_process():
            logger.info('Epoch: [{}/{}][{}/{}] '
                        ...
                        'LossDinoV2 {loss_dinov2_meter.val:.4f} '.format(epoch + 1, args.epochs, i + 1, len(train_loader),
