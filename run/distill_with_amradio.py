...
from models.disnet_with_amradio import DisNet as Model
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    train_data = FusedFeatureLoader(datapath_prefix=args.data_root,
                                    ...
                                    datapath_prefix_feat_dinov2=args.data_root_2d_fused_feature_amradio,
...
def distill(train_loader, model, optimizer, epoch):
    ...
    for i, batch_data in enumerate(train_loader):
        ...
        (coords, feat, label_3d, feat_3d, amradio_feat_3d, mask) = batch_data
        ...
        if hasattr(args, 'loss_amradio_type') and args.loss_type == 'cosine':
            loss_dinov2 = (1 - torch.nn.CosineSimilarity()
                    (output_3d_dinov2, amradio_feat_3d)).mean()
        elif hasattr(args, 'loss_amradio_type') and args.loss_type == 'l1':
            loss_dinov2 = torch.nn.L1Loss()(output_3d_dinov2, amradio_feat_3d)
        elif hasattr(args, 'loss_amradio_type') and args.loss_type == 'l2':
            loss_dinov2 = torch.nn.MSELoss()(output_3d_dinov2.float(), amradio_feat_3d.float())
        else:
            raise NotImplementedError
        ...
        if (i + 1) % args.print_freq == 0 and main_process():
            logger.info('Epoch: [{}/{}][{}/{}] '
                        ...
                        'LossAMRADIO {loss_dinov2_meter.val:.4f} '.format(epoch + 1, args.epochs, i + 1, len(train_loader),
