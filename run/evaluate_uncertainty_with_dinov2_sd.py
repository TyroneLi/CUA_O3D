...
from run.distill_uncertainty_with_EMA_v2_dinov2_sd import get_model
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.feature_type == 'fusion':
        ...
        try:
            ...
            print("Best training val mIoU : ", checkpoint['best_iou'])
        ...
        for rep_i in range(args.test_repeats):
            ...
            for i, (coords, feat, label, feat_3d, mask, inds_reverse) in enumerate(tqdm(val_data_loader)):
                ...
                if feature_type == 'distill':
                    predictions, uncertainty_pred_lseg, output_3d_dinov2, uncertainty_pred_dinov2, output_3d_sd, uncertainty_pred_sd = model(sinput)
                    
                    # orig_u_3d = uncertainty_pred.clone()
