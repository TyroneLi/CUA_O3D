...
from dataset.feature_loader_with_sd import FusedFeatureLoader, collation_fn
from dataset.point_loader_with_sd import Point3DLoader, collation_fn_eval_all
from models.disnet_with_sd import DisNet as Model
...
def distill(train_loader, model, optimizer, epoch, awl_model):
    ...
    for i, batch_data in enumerate(train_loader):
        ...
        (coords, feat, label_3d, feat_3d, sd_feat_3d, mask) = batch_data
        ...
        output_3d, output_3d_sd = model(sinput)
        ...
        # loss = loss_lseg + loss_sd
        loss = awl_model([loss_lseg, loss_sd])
