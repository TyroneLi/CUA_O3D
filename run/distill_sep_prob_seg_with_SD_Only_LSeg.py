...
from models.disnet_with_sd_SepProbSeg import DisNet as Model
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, batch_data in enumerate(train_loader):
        ...
        output_lseg, output_sd = model(sinput)
        # loss = criterion(output_lseg, label) + criterion(output_sd, label)
        # loss = criterion(output_sd, label)
        ...
        # output = (output_lseg + output_sd) / 2.0
        # output = 
        output = output_lseg
