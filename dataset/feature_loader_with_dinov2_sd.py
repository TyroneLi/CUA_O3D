...
class FusedFeatureLoader(Point3DLoader):
    ...
    def __getitem__(self, index_long):
        ...
        if self.eval_all:
            return coords, feats, labels, feat_3d, dinov2_feat_3d, sd_feat_3d, mask, torch.from_numpy(inds_reconstruct).long()
        return coords, feats, labels, feat_3d, dinov2_feat_3d, sd_feat_3d, mask
...
def collation_fn(batch):
    ...
    '''
    coords, feats, labels, feat_3d, dinov2_feat_3d, sd_feat_3d, mask_chunk = list(zip(*batch))
...
def collation_fn_eval_all(batch):
    ...
    '''
    coords, feats, labels, feat_3d, dinov2_feat_3d, sd_feat_3d, mask, inds_recons = list(zip(*batch))
