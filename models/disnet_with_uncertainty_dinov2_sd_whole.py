...
import math
from models.mink_unet_with_uncertainty_dinov2_sd import mink_unet as model3D
...
class DisNet(nn.Module):
    ...
    # @torch.no_grad()
    # def forward_teacher(self, sparse_3d):
    #     return self.module.teacher_net3d.ema(sparse_3d)
