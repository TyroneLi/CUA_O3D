...
from modules.vjepautils import PatchEmbed, PatchEmbed3D
from modules.vjepautils import Block
from modules.vjepautils import get_2d_sincos_pos_embed, get_3d_sincos_pos_embed
from modules.vjepautils import trunc_normal_
from modules.vjepautils import apply_masks

# from modules.vjepautils
...
def build_model():
    ...
    ckpt_ckpt = "./lexicon3d/modules/vjepa_ckpts/vitl16.pth.tar"
    
    state_dict = torch.load(ckpt_ckpt, map_location=torch.device('cpu'))['encoder']
    matched_state_dict = {}
